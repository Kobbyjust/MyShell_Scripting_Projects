...
bucket_name="MyS3-EventTrigger-bucket001"
lambda_func_name="s3-lambda-function"
role_name="s3-lambda-sns"
email_address="sagarinokoeaws1@gmail.com"
...
aws sns publish \
  ...
  --message "Hello from Kobina Sagari, I Learn This From DevOps Zero to Hero for Free course by Abhishek.Veeramalla on YouTube"
